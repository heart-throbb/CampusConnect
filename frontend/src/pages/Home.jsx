  ...
  return (
    <div className="min-h-[92vh] flex flex-col px-4 sm:px-6 lg:px-8 bg-gray-50">
      <div className="flex flex-col justify-center items-center text-center flex-grow py-10 sm:py-16">
        ...
        <Link
          to="/login"
          className="flex items-center gap-2 text-black px-4 sm:px-5 py-2 sm:py-3 rounded-lg text-sm sm:text-base font-medium transition duration-300 hover:underline hover:scale-110 hover:shadow-lg"
        >
          Login & Take Part
          <svg
